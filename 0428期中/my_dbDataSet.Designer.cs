...
namespace _0428期中.my_dbDataSetTableAdapters {
...
SELECT id, 姓名, 電話, 地址, email, 生日, 婚姻狀態, 點數 FROM persons WHERE (id = @id)";
        ...
        public virtual int Fill(my_dbDataSet.personsDataTable dataTable) {
        ...
        public virtual my_dbDataSet.personsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            my_dbDataSet.personsDataTable dataTable = new my_dbDataSet.personsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(my_dbDataSet.personsDataTable dataTable) {
